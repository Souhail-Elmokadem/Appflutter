...
class _ListTourState extends State<ListTour> {
  ...
  void initState() {
    ...
    listTours=context.read<TourCubit>().listTours;
  }
  @override
  void dispose() {
  ...
  void _onChangedText(String v){
    context.read<TourCubit>().getTours(page: 0,search: v);
                        ...
                        itemBuilder: (context,index){
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage(listTours[index].images[0].replaceAll("localhost", domain),),
                                    fit:BoxFit.cover,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Expanded(child: Text(listTours[index]!.tourTitle!,style: TextStyle(color: Colors.white,fontSize: 18,fontFamily: 'sf-ui',fontWeight: FontWeight.bold),)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                        SvgPicture.asset(
                                        ...
                                        FutureBuilder<String>(
                                          future: tourService.getCity(listTours[index]!.depart!.location!.point!),
                                    ...
                                    Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            listTours[index]!.price!.toString(),
